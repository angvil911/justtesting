...
class BackupManager:
    ...
    def OneClickBackups(self, request=None, userID=None, data=None):
        ...
        try:
            if request.GET.get('status', 'none') == 'success':
                ...
                try:
                    ...
                    # External platform call removed — OneClick Backups require self-hosted SFTP
                    response = None
        ...
        # External platform removed — plans should be defined locally
        url = ''  # was: platform.cyberpersons.com/Billing/FetchBackupPlans

        try:
            data['plans'] = []  # No external plans available in standalone mode
    ...
    def ManageOCBackups(self, request=None, userID=None, data=None):
        ...
        try:
            # External platform removed — stats fetched locally only
            logging.CyberCPLogFileWriter.writeToFile(f'External backup stats API removed [ManageOCBackups]')
