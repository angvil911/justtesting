...
#line1="$(grep -n "github.com/angvil911/justtesting" install.py | head -n 1 | cut -d: -f1)"
#line2=$((line1 - 1))
...
sed -i 's|git clone https://github.com/angvil911/justtesting|wget https://cyberpanel.sh/cyberpanel-git.tar.gz \&\& tar xzvf cyberpanel-git.tar.gz|g' install.py
...
if [[ $SERVER_COUNTRY == "CN" ]] ; then
	...
	if [[ $DEV == "ON" ]] ; then
	git clone https://github.com/angvil911/justtesting
	cd cyberpanel
