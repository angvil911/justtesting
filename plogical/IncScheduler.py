        ...
        for items in GDrive.objects.all():
            try:
                if items.runTime == type:
                    ...
                    try:
                        ...
                        try:
                            ...
                            r = requests.post("https://oauth2.googleapis.com/token",
                                              data={'client_id': gDriveData.get('client_id', ''),
                                                    'client_secret': gDriveData.get('client_secret', ''),
                    ...
                    # Backup retention — all features unlocked
                    if True:
                        try:
                        ...
                        for site in websites:
                            ...
                            try:
                                ...
                                if not backup_found:
                                    ...
                                    # External notification removed — log locally only
                                    logging.CyberCPLogFileWriter.writeToFile(f'Backup failure for {check_domain} logged locally [IncScheduler.startNormalBackups]')
                                else:
