...
class AIScannerManager:
    AI_SCANNER_API_BASE = ''  # External platform dependency removed
    ...
    def check_vps_free_scans(self, server_ip):
        ...
        try:
            ...
            # External platform removed — VPS free scan check disabled
            return {'success': False, 'is_vps': False, 'free_scans_available': 0}
