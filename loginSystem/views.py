...
def verifyLogin(request):
    try:
        ...
        try:
            ...
            if password_check_result and ':' in admin.password and len(admin.password.split(':')[0]) == 64:
                admin.password = hashPassword.hash_password(password)
                admin.token = hashPassword.generateToken(admin.userName, password)
                admin.save()
